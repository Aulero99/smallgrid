...
const distFolder = `suspendors-${pkg.version}-examples`
...
const cssFiles = [
  'suspendors.min.css',
  'suspendors.min.css.map',
  'suspendors.rtl.min.css',
  'suspendors.rtl.min.css.map'
]
const jsFiles = [
  'suspendors.bundle.min.js',
  'suspendors.bundle.min.js.map'
]
const imgFiles = [
  'suspendors-logo.svg',
  'suspendors-logo-white.svg'
]
const staticJsFiles = [
  'color-modes.js'
]
